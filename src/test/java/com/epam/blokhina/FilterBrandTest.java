...
public class FilterBrandTest extends BaseTest {
    ...
    public void testBrandFilter() {
        assertTrue(breadmakerSteps.selectBrand().verifyBrandFilter(), "Verify that brand filter shows all the items that should show up and does not show anything extra.");
    }
